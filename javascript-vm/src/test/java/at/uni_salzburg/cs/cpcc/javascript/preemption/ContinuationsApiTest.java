...
public class ContinuationsApiTest
{
    ...
    /**
     * Since a continuation can only capture JavaScript frames and not Java frames, ensure that Rhino throws an
     * exception when the JavaScript frames don't reach all the way to the code called by executeScriptWithContinuations
