...
import at.uni_salzburg.cs.cpcc.utilities.FileLoader;
...
public class BuiltinTest
{
    ...
    private JSInterpreter createJSI(String resourceName, boolean addTransient) throws IllegalAccessException,
    ...
    @Test
    public void testPrintln() throws IOException, IllegalAccessException, InstantiationException,
    ...
    @Test
    public void testMigrate() throws IOException, IllegalAccessException, InstantiationException,
        InvocationTargetException
    {
    ...
    @Test
    public void testMigrateTransient() throws IOException, IllegalAccessException, InstantiationException,
        InvocationTargetException
    {
    ...
    @Test
    public void testPosSimple() throws IOException, IllegalAccessException, InstantiationException,
        InvocationTargetException
    {
    ...
    @Test
    public void testPosCompare() throws IOException, IllegalAccessException, InstantiationException,
        InvocationTargetException
    {
    ...
    @Test
    public void testRandom() throws IllegalAccessException, InstantiationException, InvocationTargetException,
        IOException
    {
    ...
    @Test
    public void testFile() throws IllegalAccessException, InstantiationException, InvocationTargetException,
        IOException
    {
    ...
    @Test
    public void testPrintWriter() throws IllegalAccessException, InstantiationException, InvocationTargetException,
        IOException
    {
        JSInterpreter jsi = createJSI("test-js/builtin-printwriter.js", false);
        byte[] snapshot = jsi.start();
        jsi.close();
        String result = FileLoader.loadFileAsString(new File(tmpDir, "lala.txt"), "UTF-8");
        assertEquals("test01\ntest02\n", result);
        ...
        String output = cons.result.toString();
        assertEquals("", output);
        result = FileLoader.loadFileAsString(new File(tmpDir, "lala.txt"), "UTF-8");
        assertEquals("test01\ntest02\ntest03\n", result);
    }

    @Test
    public void testLatLngAlt() throws IllegalAccessException, InstantiationException, InvocationTargetException,
        IOException
    {
        ...
        jsi.close();
        String output = cons.result.toString();
        assertEquals("(48.00000000, 13.00000000, 20.000)\n"
            + "48.0\n"
            + "13.0\n"
            + "20.0\n"
    ...
    @Test
    public void testSensorValue() throws IllegalAccessException, InstantiationException, InvocationTargetException,
        IOException
    {
        ...
        jsi.close();
        String output = cons.result.toString();
        assertEquals("temperature (1343148941620, 19.300000)\n"
            + "airPressure\n"
    ...
    @Test
    public void testActionPoint() throws IllegalAccessException, InstantiationException, InvocationTargetException,
        IOException
    {
        ...
        jsi.close();
        String output = cons.result.toString();
        assertEquals("Point (48.00000000, 13.00000000, 20.000) tolerance 3.0\n"
