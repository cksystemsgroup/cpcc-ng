 ...
 */
public class RealVehicleStateServiceImplOld implements RealVehicleStateServiceOld
{
     ...
     */
    public RealVehicleStateServiceImplOld(QueryManager qm, CommunicationService com)
    {
        this.qm = qm;
        this.com = com;
    ...
    public static class RvStatusCallable implements Callable<CommunicationResponse>
    {
        ...
        public CommunicationResponse call() throws Exception
        {
            ...
            try
            {
                CommunicationResponse resp = com.transfer(
                    status.getRealVehicle(), RealVehicleBaseConstants.REAL_VEHICLE_STATUS_CONNECTOR, new byte[0]);
