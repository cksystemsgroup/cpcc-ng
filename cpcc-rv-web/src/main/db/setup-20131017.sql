...
INSERT INTO DEVICE (ID,CONFIGURATION,TOPICROOT,TYPE_ID) VALUES (27,'gps=''/quad01/gps'' osmZoomLevel=18 osmTileServerUrl=''http://khm1.google.com/kh/v=128&src=app&x=%2$d&y=%3$d&z=%1$d&s=Galileo''  cameraApertureAngle=2','/quad01/camera',1);
INSERT INTO DEVICE (ID,CONFIGURATION,TOPICROOT,TYPE_ID) VALUES (28,null,'/gscam',9);
INSERT INTO DEVICE (ID,CONFIGURATION,TOPICROOT,TYPE_ID) VALUES (29,'gps=''/mav01/gps'' osmZoomLevel=18 osmTileServerUrl=''http://khm1.google.com/kh/v=128&src=app&x=%2$d&y=%3$d&z=%1$d&s=Galileo'' origin=(37.80806;-122.42661;0) cameraApertureAngle=2','/mav01/camera2',5);
...
INSERT INTO MAPPINGATTRIBUTES (CONNECTEDTOAUTOPILOT,VVVISIBLE,TOPIC_ID,DEVICE_ID) VALUES (0,0,1,29);
INSERT INTO MAPPINGATTRIBUTES (CONNECTEDTOAUTOPILOT,VVVISIBLE,TOPIC_ID,DEVICE_ID) VALUES (0,0,2,29);
