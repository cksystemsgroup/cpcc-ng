 ...
 */
public class JobExecutionException extends IOException
{
    private static final long serialVersionUID = 2401696450291436968L;

    /**
     * Constructs an {@code JobExecutionException} with {@code null} as its error detail message.
     */
    ...
    /**
     * Constructs an {@code JobExecutionException} with the specified detail message.
     *
    ...
    /**
     * Constructs an {@code JobExecutionException} with the specified detail message and cause.
     * <p>
