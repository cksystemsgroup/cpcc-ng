...
VALUES (8,'origin=(47.822898;13.038793;0) maxVelocity=20 maxAcceleration=5 precision=10 updateCycle=100 idlePower=20 hoverPower=55 mass=2.2 takeOffHeight=10 takeOffVelocity=2 takeOffAcceleration=2 landingVelocity=1.5 landingAcceleration=2','/quad01',4);
...
INSERT INTO PARAMETERS (ID,NAME,SORT,VALUE) VALUES (1,'realVehicleName',0,'RV01');
INSERT INTO PARAMETERS (ID,NAME,SORT,VALUE) VALUES (2,'masterServerURI',0,'http://localhost:13001');
INSERT INTO PARAMETERS (ID,NAME,SORT,VALUE) VALUES (3,'useInternalRosCore',0,'true');

UPDATE real_vehicles SET last_update = SYSDATE WHERE name = 'RV01';

-- INSERT INTO DEVICES (ID,CONFIGURATION,TOPIC_ROOT,TYPE_ID)
-- VALUES (9,'gps=''/quad01/gps'' osmZoomLevel=21 osmTileServerUrl=''http://khm0.googleapis.com/kh?v=192&hl=en-US&x=%2$s&y=%3$s&z=%1$s&token=108840''','/quad01/camera',1);
-- 
